######IMPORTANT
The ddpg.py file is altered slightly to work with Tensorflow 2.2.0, replace the file in Keras-rl/agents with this version
######
SETUP

To run the code, type into the command line interface;

~$	 python Jordan-MSc-Code.py

This will run the script according to the parameters set up within the file, the description of functions is detailed within the code itself.
The sources of sections of code have been listed in the comments where applicable.

######
critic_diagram.py and actor_diagram.py

To run the code, type into the command line interface;

~$	 python critic_diagram.py
~$	 python actor_diagram.py

These files are used to generate the network diagrams seen within the report.

###### Conda Environment Packages
A full list of dependancies for the successful execution of the files are shown below:
...
google-auth               1.14.2                    <pip>
google-auth-oauthlib      0.4.1                      py_2
google-pasta              0.2.0                      py_0
gql                       0.2.0                     <pip>
graphite2                 1.3.13               h23475e2_0
graphql-core              1.1                       <pip>
...
llvmlite                  0.32.0           py37hd408876_0
locket                    0.2.0                    py37_1
...
sentry-sdk                0.14.3                    <pip>
setuptools                46.1.3                    <pip>
...
testpath                  0.4.4                      py_0
tf-estimator-nightly      2.4.0.dev2020072301           <pip>
